        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div className="mt-8 text-center">
            <p className="">
              <Link
                to="/about"
                className="text-center border-default  px-8 py-4 rounded-md items-center text-primary-color font-semibold hover:text-primary-hover transition-colors text-lg"
              >
